...
$joomlaPath = $_SERVER['HOME'] . '/Sites/boot4';
...
// Load FOF 3
if (!defined('FOF40_INCLUDED') && !@include_once(__DIR__ . '/../fof/include.php'))
{
	throw new RuntimeException('FOF 4.x is not installed', 500);
}
...
$autoloader->addClassMap([
	...
	'FEFHelperBrowse'                => __DIR__ . '/../fof/Html/FEFHelper/browse.php',
	'FEFHelperEdit'                  => __DIR__ . '/../fof/Html/FEFHelper/edit.php',
	'FEFHelperSelect'                => __DIR__ . '/../fof/Html/FEFHelper/select.php',
	# Post-installation scripts, package and component
	'file_fof40InstallerScript'      => __DIR__ . '/../fof/script.fof.php',
	# Plugins
